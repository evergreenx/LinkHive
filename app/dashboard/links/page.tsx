  ...
  return (
    <motion.div className=" flex flex-col h-screen  px-[18px]">
      ...
      >
        ...
        <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex bg-white w-full lg:w-[53%] rounded-[1rem] py-5 px-8 mt-5">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="URL" {...field} className='w-full lg:w-[200%] px-4 py-6 border-none outline-none focus:border-none bg-[#ececec] placeholder:text-md'/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        />
          <Button className="bg-[#000] lg:w[55%] ml-[15rem] my-8 rounded-full py-5 px-5 text-white font-bold" type='submit'>
            Add
          </Button>
      </form>
          </Form>
          <Button className="bg-[#000] w-full lg:w-[53%]  mx-auto my-8 rounded-full py-3 px-3 text-white font-bold" type='submit'>
            Add link
          </Button>
      </motion.div>
